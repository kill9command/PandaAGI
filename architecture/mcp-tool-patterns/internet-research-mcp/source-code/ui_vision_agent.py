...
Integration: Used by human_web_navigator for pagination, "load more", consent banners,
...
# Prompt loading
_PROMPT_DIR = Path(__file__).parent.parent / "apps" / "prompts" / "utility"
_prompt_cache: Dict[str, str] = {}


def _load_prompt(prompt_name: str) -> str:
    """Load a prompt file from the utility prompts directory."""
...
class TargetingPolicy:
    ...
    async def llm_select_candidate(
        ...
        prompt_template = _load_prompt("ui_element_selector")
        if prompt_template:
