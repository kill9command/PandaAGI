...
class CrawlerSessionManager:
    ...
    async def get_or_create_session(
        ...
        from orchestrator.browser_fingerprint import BrowserFingerprint
        ...
        print(f"[DEBUG] About to inject stealth for {session_key}", flush=True)
        from orchestrator.stealth_injector import inject_stealth
        await inject_stealth(context, log=True)
        print(f"[DEBUG] Stealth injection complete for {session_key}", flush=True)
