    ...
    try:
        ...
        if blocker and blocker["confidence"] >= 0.7:
            ...
            if blocker["type"].value == "rate_limit":
                ...
                from orchestrator.search_engine_health import get_engine_health_tracker
...
async def search_with_fallback(
    ...
    """
    from orchestrator.search_rate_limiter import get_search_rate_limiter
    from orchestrator.serp_cache import get_serp_cache
