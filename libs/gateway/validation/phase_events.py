...
# Map 9-phase pipeline to UI stage names and descriptions
# UI stages: query_received, guide_analyzing, coordinator_planning,
#            orchestrator_executing, guide_synthesizing, response_complete
# Phase mapping (from architecture/README.md):
#   0: query_analyzer, 1: reflection, 2: context_gatherer, 3: planner,
#   4: executor, 5: coordinator, 6: synthesis, 7: validation, 8: save
PHASE_TO_STAGE = {
    0: ("query_received", "Analyzing query"),
    1: ("guide_analyzing", "Reflecting on query"),
    2: ("guide_analyzing", "Gathering context"),
    3: ("coordinator_planning", "Planning approach"),
    4: ("orchestrator_executing", "Executing commands"),
    5: ("orchestrator_executing", "Coordinating tools"),
    6: ("guide_synthesizing", "Generating response"),
    7: ("guide_synthesizing", "Validating response"),
    8: ("guide_synthesizing", "Saving turn data"),
}
...
async def phase_progress(
    ...
    Args:
        ...
        phase_num: The phase number (0-8)
