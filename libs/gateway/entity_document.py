...
as new information is discovered. Each entity (vendor, product, site, topic, person)
gets its own markdown file that accumulates:
...
class EntityDocument:
    ...
    Usage:
        ...
        doc.add_property("url", "https://poppybee.com", "turn_64")
        doc.add_property("price_range", "$50-$100", "turn_64")
        doc.add_mention(64, "User researched hamster breeders")
        doc.add_related_entity(15, "product", "Syrian Hamster", "sells")
        doc.save(vault_path)
    """
    entity_type: str
    canonical_name: str
