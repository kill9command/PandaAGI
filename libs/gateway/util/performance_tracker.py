...
class TurnOutcome:
    ...
    # Classification
    # NOTE: Maps to 'intent' column in SQLite for backward compat with existing data
...
class PerformanceTracker:
    ...
    def record_outcome(self, outcome: TurnOutcome) -> None:
        ...
        with self._connect() as conn:
            ...
            """, (
                ...
                outcome.session_id,
                outcome.timestamp,
                outcome.action_needed,  # Maps to 'intent' DB column
    ...
    def record_from_metadata(self, metadata: Dict[str, Any]) -> None:
        ...
        outcome = TurnOutcome(
            ...
            action_needed=metadata.get("action_needed") or metadata.get("intent"),
    ...
    def query_recent_failures(
        ...
        """
        Query recent failures for a specific action_needed value.
        ...
        with self._connect() as conn:
            rows = conn.execute("""
                ...
                LIMIT ?
            """, (action_needed, cutoff, limit)).fetchall()
    ...
    def query_action_stats(self, action_needed: str, hours: float = 168.0) -> Dict[str, Any]:
        """
        Query statistics for a specific action_needed value over time window.
    ...
    def _row_to_outcome(self, row: sqlite3.Row) -> TurnOutcome:
        ...
        return TurnOutcome(
            ...
            action_needed=row["intent"],  # DB column still named 'intent'
