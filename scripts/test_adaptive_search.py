...
from apps.services.tool_server.product_schema import ProductSearchIntent
from apps.services.tool_server.research_mcp import discover_sources
from apps.services.tool_server.commerce_mcp_v2 import search_with_intent
