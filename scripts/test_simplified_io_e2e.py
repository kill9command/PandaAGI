...
from libs.gateway.context_gatherer_role import ContextGathererRole, gather_context
...
async def simulate_turn_1_preference_statement():
    ...
    # Phase 1: Context Gatherer (minimal for new session)
    context_doc.append_section(1, "Gathered Context", """### Session Preferences
...
""")
    ...
    # Phase 2: Reflection
    context_doc.append_section(2, "Reflection Decision", """**Decision:** PROCEED
...
""")
    ...
    # Phase 5: Synthesis
    context_doc.append_section(5, "Synthesis", """**Response Preview:**
...
async def simulate_turn_3_preference_recall():
    ...
    print("Context Gatherer output (§0 and §1):")
    print(context_doc.get_markdown())

    # Check that we found the preference turn, NOT the laptop turn
    gathered_context = context_doc.get_section(1)
    print("\n" + "-" * 40)
    print("VERIFICATION:")
    print("-" * 40)
...
""")
    ...
    # Phase 5: Synthesis (§4 skipped)
    context_doc.append_section(5, "Synthesis", """**Response Preview:**
Your favorite hamster is the Syrian hamster.

**Validation Checklist:**
- [x] Claims match evidence (preference from §1)
