...
os.environ["SAVED_REPO"] = "/path/to/your/project"
os.environ["ENFORCE_MODE_GATES"] = "1"
os.environ["EXTERNAL_REPO_TIMEOUT"] = "5"  # Short timeout for testing

from libs.gateway.execution.permission_validator import (
    PermissionValidator,
    PermissionDecision,
    ValidationResult,
    reset_validator,
...
def test_mode_gates_chat_denied():
    ...
    write_tools = [
        ("file.write", {"file_path": "/path/to/your/project/test.txt"}),
        ("file.edit", {"file_path": "/path/to/your/project/test.txt"}),
        ("git.commit", {"repo": "/path/to/your/project", "message": "test"}),
        ("bash.execute", {"cwd": "/path/to/your/project", "command": "ls"}),
    ]
...
def test_mode_gates_code_allowed():
    ...
    write_tools = [
        ("file.write", {"file_path": "/path/to/your/project/test.txt"}),
        ("file.edit", {"file_path": "/path/to/your/project/src/main.py"}),
        ("git.commit", {"repo": "/path/to/your/project", "message": "test"}),
        ("bash.execute", {"cwd": "/path/to/your/project", "command": "ls"}),
    ]
...
def test_repo_scope_external_needs_approval():
    ...
    external_operations = [
        ("file.write", {"file_path": "/home/user/pythonprojects/OTHER_PROJECT/test.txt"}),
        ("git.commit", {"repo": "/home/user/pythonprojects/OTHER_PROJECT", "message": "test"}),
