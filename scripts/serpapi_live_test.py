...
#   set -a && source .env && PYTHONPATH=/home/henry/pythonprojects/pandaai python scripts/serpapi_live_test.py

def main():
    try:
        from apps.services.orchestrator import context_builder, serpapi_quota
    ...
    search_request = {
        "queries": [
            "prompts and context management pandaai",
            "pandaai search process",
