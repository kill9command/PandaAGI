...
from libs.gateway.research_index_db import ResearchIndexDB, get_research_index_db
from libs.gateway.context_gatherer_role import ContextGathererRole
    ...
    tool_results = {
        ...
        "findings": [
            ...
            },
            {
                ...
                "price": "$70",
                "vendor": "poppybeehamstery.com",
                "url": "https://poppybeehamstery.com",
