...
Usage:
  set -a && source .env && PYTHONPATH=/home/henry/pythonprojects/pandaai python scripts/refetch_playwright_and_regen.py
...
def refetch_url_with_playwright(url: str, staged_root: str = str(STAGING_ROOT)) -> Dict[str, Any]:
    try:
        from apps.services.orchestrator import web_fetcher  # type: ignore
...
def main():
    ...
    try:
        ...
        cmd = 'set -a && source .env && PYTHONPATH=/home/henry/pythonprojects/pandaai python scripts/generate_noteframes.py'
