...
def send_query(query: str, profile_id: str = PROFILE_ID):
    ...
    if trace_id:
        ...
        verbose_path = Path(f"/home/henry/pythonprojects/pandaai/transcripts/verbose/{day}/{trace_id}.json")
...
def main():
    ...
    session_ctx_path = Path(f"/home/henry/pythonprojects/pandaai/panda_system_docs/shared_state/session_contexts/{PROFILE_ID}.json")
