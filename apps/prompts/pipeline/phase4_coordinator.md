...
- Name specific tools — only name workflows
- Execute multiple workflows in one selection
- Ignore mode constraints on write operations
- Guess workflow arguments not supported by the command or context
