"""
apps/services/tool_server/commerce_mcp.py
...
from apps.services.tool_server.product_schema import (
    ProductSearchIntent,
    ProductListing,
    SearchQuality,
    infer_item_type,
...
from apps.services.tool_server.web_fetcher_resilient import fetch_url
from apps.services.tool_server.data_normalizer import get_normalizer
from apps.services.tool_server.memory_store import get_memory_store
from apps.services.tool_server.species_taxonomy import validate_species_match
import httpx
import json
import re
...
async def quick_search(
    ...
    """
    from apps.services.tool_server.commerce_search_multi_phase import get_search_orchestrator
