...
Usage:
    # Replace old imports:
    # from apps.services.orchestrator.smart_calibrator import get_smart_calibrator
...
from apps.services.orchestrator.page_intelligence.service import (
...
class UnifiedCalibratorAdapter:
    ...
    def delete_calibration(self, domain: str) -> bool:
        ...
        try:
            from apps.services.orchestrator.page_intelligence.cache import get_cache
            cache = get_cache()
