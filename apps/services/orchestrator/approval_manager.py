...
class ApprovalManager:
    ...
    def get_pending_interventions(self, session_id: Optional[str] = None) -> List[Dict]:
        ...
        """
        from apps.services.orchestrator.captcha_intervention import get_all_pending_interventions
    ...
    def get_intervention_stats(self) -> Dict[str, Any]:
        ...
        from apps.services.orchestrator.captcha_intervention import get_intervention_stats
...
async def require_approval(
    ...
    """
    from apps.services.orchestrator.safety_validator import (
