...
from apps.services.orchestrator.product_claim_schema import ProductClaim
...
def _load_prompt_via_recipe(recipe_name: str, category: str = "tools") -> str:
    ...
    Args:
        recipe_name: Name of the recipe (e.g., "product_extractor")
    ...
    try:
        ...
        logger.warning(f"[ProductExtractor] Recipe {cache_key} not found: {e}")
        return ""
