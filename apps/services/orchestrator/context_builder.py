...
from apps.services.orchestrator.shared_state.schema import TaskTicket
from apps.services.orchestrator.claim_quality import ClaimQualityScorer
...
async def compile_capsule(
    ...
    *,
    ...
    for cand in top_candidates:
        ...
        cand.fingerprint = ClaimRegistry._fingerprint(claim_obj)  # type: ignore[attr-defined]
...
def _score_candidates(
    ...
    *,
    ...
    for cand in candidates:
        ...
        fingerprint = ClaimRegistry._fingerprint(temp_claim)  # type: ignore[attr-defined]
