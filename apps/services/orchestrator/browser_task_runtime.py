...
class BrowserTaskRuntime:
    ...
    async def _execute_action(self, action: BrowserAction) -> Dict[str, Any]:
        ...
        from apps.services.orchestrator.ui_vision_agent import UIVisionAgent
    ...
    async def _request_human_intervention(self, reason: str):
        ...
        from apps.services.orchestrator.intervention_manager import get_intervention_manager
...
async def execute_browser_task(
    ...
    Example:
        ...
        from apps.services.orchestrator.browser_task_runtime import execute_browser_task, BrowserAction, ActionType
