...
from apps.services.orchestrator.shared_state.claims import ClaimRegistry, ClaimRow
from apps.services.orchestrator.shared_state.topic_index import TopicIndex, Topic, TopicMatch, get_topic_index
from apps.services.orchestrator.shared_state.claim_types import ClaimType, PHASE1_CLAIM_TYPES, REUSABLE_CLAIM_TYPES
...
class KnowledgeRetriever:
    ...
    def claim_registry(self) -> ClaimRegistry:
        ...
        if self._claim_registry is None:
            from apps.services.orchestrator.shared_state.claims import get_claim_registry
    ...
    def _get_retailer_tokens(self) -> List[str]:
        ...
        tokens = set()
        try:
            from apps.services.orchestrator.shared_state.vendor_registry import get_vendor_registry
    ...
    async def retrieve_for_query(
        ...
        Args:
            ...
            min_similarity: Minimum topic similarity (default: 0.75)
