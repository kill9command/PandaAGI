...
from apps.services.orchestrator.shared_state.topic_index import TopicIndex, Topic, get_topic_index
...
def _load_prompt_via_recipe(recipe_name: str, category: str = "research") -> str:
    ...
    Args:
        recipe_name: Name of the recipe (e.g., "topic_extractor")
        category: Recipe category (default "research")
    ...
    try:
        ...
        logger.warning(f"[KnowledgeExtractor] Recipe {cache_key} not found: {e}")
        return ""
